...
CREATE TABLE tipo_identificacion (
  id_tipo_identificacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del tipo de identificacion',
...
CREATE TABLE tipo_persona (
  id_tipo_persona INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del tipo de persona',
...
CREATE TABLE tipo_telefono (
  id_tipo_telefono INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del tipo de telefono',
...
CREATE TABLE estado_proveedor (
  id_estado_proveedor INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del estado del proveedor',
...
CREATE TABLE pais (
  id_pais INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del pais',
...
CREATE TABLE departamento (
  id_departamento INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del departamento/estado',
...
CREATE TABLE tipo_pago (
  id_tipo_pago INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del tipo de pago',
...
CREATE TABLE origen_dato (
  id_origen INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del origen de datos',
...
CREATE TABLE calificacion (
  id_calificacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la calificacion',
...
CREATE TABLE tipo_notificacion (
  id_tipo_notificacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del tipo de notificacion',
...
CREATE TABLE estado_usuario (
  id_estado_usuario INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del estado de usuario',
...
CREATE TABLE municipio (
  id_municipio INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del municipio/ciudad',
...
CREATE TABLE proveedores (
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_prov_tipo_identificacion FOREIGN KEY (id_tipo_identificacion) REFERENCES tipo_identificacion(id_tipo_identificacion) 
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT fk_prov_tipo_persona FOREIGN KEY (id_tipo_persona) REFERENCES tipo_persona(id_tipo_persona) 
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT fk_prov_tipo_telefono FOREIGN KEY (id_tipo_telefono) REFERENCES tipo_telefono(id_tipo_telefono) 
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT fk_prov_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_prov_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Informacion principal de proveedores registrados en el sistema';

CREATE TABLE contacto (
  id_contacto INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del contacto',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_contacto_tipo_telefono FOREIGN KEY (id_tipo_telefono) REFERENCES tipo_telefono(id_tipo_telefono)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_contacto_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_contacto_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Personas de contacto que pueden estar asociadas a multiples proveedores';

CREATE TABLE forma_de_pago (
  id_forma_pago INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la forma de pago',
  ...
  CONSTRAINT fk_fp_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_fp_tipo_pago FOREIGN KEY (id_tipo_pago) REFERENCES tipo_pago(id_tipo_pago)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_fp_prov_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_fp_prov_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
...
CREATE TABLE documentos (
  id_documento INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del documento',
  ...
  fecha_modificado DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de ultima modificacion',
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  CONSTRAINT fk_doc_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_doc_tipo FOREIGN KEY (id_tipo_documento) REFERENCES tipo_documento(id_tipo_documento)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
    CONSTRAINT fk_doc_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_doc_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Documentos digitales asociados a proveedores con multiples opciones de almacenamiento';

CREATE TABLE representante_legal (
  id_representante_legal INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del representante legal',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_rl_tipo_identificacion FOREIGN KEY (id_tipo_identificacion) REFERENCES tipo_identificacion(id_tipo_identificacion)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_rl_tipo_telefono FOREIGN KEY (id_tipo_telefono) REFERENCES tipo_telefono(id_tipo_telefono)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_rl_usuario FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_rl_prov_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_rl_prov_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_rl_id_documento FOREIGN KEY (id_documento) REFERENCES documentos(id_documento)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Representantes legales autorizados de proveedores personas juridicas';

CREATE TABLE socios_proveedor (
  id_socio_proveedor INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del socio',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_soc_prov FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_soc_tipo_identificacion FOREIGN KEY (id_tipo_identificacion) REFERENCES tipo_identificacion(id_tipo_identificacion)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_soc_origen FOREIGN KEY (id_origen) REFERENCES origen_dato(id_origen)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_soc_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_soc_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Socios, accionistas o participes de proveedores personas juridicas';

CREATE TABLE validacion (
  id_validacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la validacion',
  ...
  CONSTRAINT fk_val_usuario FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario)     
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_val_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_val_campo FOREIGN KEY (id_campo_validacion) REFERENCES campo_validacion(id_campo_validacion)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_val_documento FOREIGN KEY (id_documento) REFERENCES documentos(id_documento)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_val_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_val_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
...
CREATE TABLE evaluacion_riesgos (
  id_evaluacion_riesgos INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la evaluacion de riesgos',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_er_usuario FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_er_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_er_validacion FOREIGN KEY (id_validacion) REFERENCES validacion(id_validacion)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_er_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_er_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
...
CREATE TABLE evaluacion_proveedor (
  id_evaluacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la evaluacion',
  id_proveedor INT NOT NULL COMMENT 'Proveedor evaluado',
  id_usuario INT NOT NULL COMMENT 'Usuario que realizo la evaluacion',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_eval_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_eval_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_eval_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_eval_usuario FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_eval_calificacion FOREIGN KEY (id_calificacion) REFERENCES calificacion(id_calificacion)    
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Evaluaciones periodicas de desempeno y cumplimiento de proveedores';

CREATE TABLE notificaciones (
  id_notificacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la notificacion',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_notif_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_notif_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
...
CREATE TABLE historial_usuario (
  id_historial_usuario INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico del registro historico',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_hist_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_hist_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_hist_usuario FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_hist_estado FOREIGN KEY (id_estado_usuario) REFERENCES estado_usuario(id_estado_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
...
CREATE TABLE proveedor_contacto (
  ...
  CONSTRAINT fk_pc_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT fk_pc_contacto FOREIGN KEY (id_contacto) REFERENCES contacto(id_contacto)
    ON DELETE RESTRICT 
    ON UPDATE CASCADE,
    CONSTRAINT fk_pc_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_pc_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
) ENGINE=InnoDB COMMENT='Relacion muchos-a-muchos entre proveedores y sus contactos';

CREATE TABLE ubicacion (
  id_ubicacion INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador unico de la ubicacion',
  ...
  modificado_por INT NULL COMMENT 'Usuario que realizo la ultima modificacion',
  activo BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Indica si el registro está activo (TRUE) o inactivo/eliminado (FALSE) para soft delete',
  CONSTRAINT fk_ubicacion_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedores(id_proveedor)
    ON DELETE RESTRICT 
    ON UPDATE CASCADE,
  CONSTRAINT fk_ubicacion_municipio FOREIGN KEY (id_municipio) REFERENCES municipio(id_municipio)
    ON DELETE RESTRICT 
    ON UPDATE CASCADE,
  CONSTRAINT fk_ubicacion_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_ubicacion_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
...
CREATE TABLE documentos_socios_proveedor (
  ...
  CONSTRAINT fk_dsp_socio FOREIGN KEY (id_socio_proveedor) REFERENCES socios_proveedor(id_socio_proveedor)
  ON DELETE RESTRICT 
  ON UPDATE CASCADE,
  CONSTRAINT fk_dsp_documento FOREIGN KEY (id_documento) REFERENCES documentos(id_documento)
  ON DELETE RESTRICT 
  ON UPDATE CASCADE,
  CONSTRAINT fk_dsp_creado_por FOREIGN KEY (creado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT,
  CONSTRAINT fk_dsp_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id_usuario)
    ON DELETE RESTRICT 
    ON UPDATE RESTRICT
...
-- Indexes adicionales
CREATE INDEX idx_proveedores_numero_ident ON proveedores(numero_identificacion) COMMENT 'Indice para busquedas rapidas por numero de identificacion';
