...
INSERT INTO proveedores (id_tipo_identificacion, numero_identificacion, digito_verificacion, razon_social, nombres, apellidos, id_tipo_persona, telefono_principal, id_tipo_telefono, correo_principal, creado_por, descripcion) VALUES
(1,'900123456',0,'Soluciones Andinas S.A.S.',NULL,NULL,2,'6041234567',1,'contacto@soluandinas.com',1,'Proveedor de insumos informaticos'),
(1,'900223456',0,'Servicios Logitek SAS',NULL,NULL,2,'6047654321',1,'info@logitek.com',1,'Soporte tecnico'),
(2,'1023456789',NULL,NULL,'Carlos','Mejia',1,'3101234567',1,'cmejia@gmail.com',2,'Tecnico independiente'),
(2,'1023456790',NULL,NULL,'Maria','Gonzalez',1,'3119876543',1,'maria.g@correo.com',2,'Especialista en redes'),
(1,'900323456',0,'TecnoSoluciones Ltda',NULL,NULL,2,'6043334444',1,'ventas@tecnosol.com',1,'Distribuidor'),
(2,'1023456791',NULL,NULL,'Andres','Perez',1,'3155556666',1,'andres.p@example.com',3,'Consultor'),
(1,'900423456',0,'Comercial Norte S.A.',NULL,NULL,2,'6044445555',1,'contacto@cnorte.com',1,'Suministros generales'),
(2,'1023456792',NULL,NULL,'Laura','Ramirez',1,'3122223333',1,'laura.r@example.com',2,'Ingeniera de sistemas'),
(1,'900523456',0,'GlobalTech Colombia',NULL,NULL,2,'6049998888',1,'info@globaltech.co',1,'Hardware y software'),
(2,'1023456793',NULL,NULL,'Diego','Rojas',1,'3177776666',1,'drojas@example.com',3,'Proveedor independiente'),
(1,'900623456',0,'Insumos Medicos SAS',NULL,NULL,2,'6041112222',1,'ventas@insumosmed.com',1,'Insumos hospitalarios'),
(2,'1023456794',NULL,NULL,'Paula','Cardenas',1,'3188887777',1,'paula.c@example.com',2,'Tecnica'),
(1,'900723456',0,'Soluciones Agro SAS',NULL,NULL,2,'6046665555',1,'agro@soluciones.com',1,'Agricultura'),
(2,'1023456795',NULL,NULL,'Fernando','Lopez',1,'3196665555',1,'f.lopez@example.com',3,'Tecnico en mantenimiento'),
(1,'900823456',0,'Servicios Integrales Gomez',NULL,NULL,2,'6047776666',1,'gomez@servicios.com',1,'Servicios varios'),
(2,'1023456796',NULL,NULL,'Natalia','Silva',1,'3205554444',1,'natalia.s@example.com',2,'Soporte'),
(1,'900923456',0,'Alpha Sistemas S.A.S.',NULL,NULL,2,'6042221111',1,'alpha@sys.com',1,'Software y consultoria'),
(2,'1023456797',NULL,NULL,'Ricardo','Martinez',1,'3214443333',1,'ricardo.m@example.com',3,'Freelance'),
(1,'901023456',0,'Distribuciones Andinas',NULL,NULL,2,'6043332222',1,'dist@andinas.com',1,'Logistica'),
(2,'1023456798',NULL,NULL,'Sofia','Herrera',1,'3223334444',1,'sofia.h@example.com',2,'Asesora');

INSERT INTO ubicacion (id_proveedor, id_municipio, direccion, creado_por) VALUES
(1,1,'Calle 10 #45-20, Medellin',1),
(2,1,'Av. 80 #34-12, Medellin',1),
(3,2,'Carrera 5 #12-34, Bogota',2),
(4,2,'Calle 12 #4-56, Bogota',2),
(5,1,'Parque Industrial Km 4',1),
(6,3,'Avenida 6N #23-45, Cali',3),
(7,4,'Carrera 54 #68-12, Barranquilla',1);

INSERT INTO contacto (nombre_contacto, cargo_contacto, id_tipo_telefono, telefono_contacto, correo_contacto, creado_por) VALUES
('Luis Torres','Jefe de compras',1,'3101002001','luis.torres@soluandinas.com',1),
('Mariana Ruiz','Coordinadora',1,'3102003002','mariana.ruiz@logitek.com',1),
('Carlos Medina','Soporte',1,'3103004003','c.medina@tecnosol.com',1),
('Ana Villamil','Finanzas',1,'3104005004','ana.v@cnorte.com',1),
('Pedro Castillo','Representante',1,'3105006005','pedro.castillo@globaltech.co',1),
('Diana Mejia','Compras',1,'3106007006','diana.mejia@insumosmed.com',1),
('Esteban Cruz','Logistica',1,'3107008007','esteban.cruz@agro.com',1),
('Rosa Morales','Asistente',1,'3108009008','rosa.morales@gomez.com',1),
('Eduardo Perez','Gerente',1,'3109001009','eduardo.perez@alpha.com',1),
('Valentina Soto','Asesora',1,'3110001110','valentina.soto@dist.com',1),
('Andres Gil','Tecnico',1,'3111002221','andres.gil@example.com',1),
('Catalina Lopez','Analista',1,'3112003332','catalina.lopez@example.com',1),
('Javier Nunez','Representante',1,'3113004443','javier.nunez@example.com',1),
('Clara Mejia','Coordinadora',1,'3114005554','clara.mejia@example.com',1),
('Miguel Angel','Supervisor',1,'3115006665','miguel.angel@example.com',1),
('Laura Osorio','Auditor',1,'3116007776','laura.osorio@example.com',1),
('Renata Diaz','Jefe RRHH',1,'3117008887','renata.diaz@example.com',1),
('Hugo Salazar','Administrador',1,'3118009998','hugo.salazar@example.com',1),
('Beatriz Rojas','Secretaria',1,'3119000009','beatriz.rojas@example.com',1),
('Oscar Herrera','Comprador',1,'3120001112','oscar.herrera@example.com',1);

INSERT INTO proveedor_contacto (id_proveedor, id_contacto, creado_por) VALUES
(1,1,1),(2,2,1),(5,3,1),(7,4,1),(9,5,1),(11,6,1),(13,7,1),(15,8,1),(17,9,1),(19,10,1),
(3,11,2),(4,12,2),(6,13,3),(8,14,2),(10,15,3),(12,16,2),(14,17,3),(16,18,2),(18,19,3),(20,20,2);

INSERT INTO representante_legal (id_tipo_identificacion, numero_identificacion, nombres, apellidos, id_tipo_telefono, telefono, correo, creado_por) VALUES
(2,'102000111','Fernando','Gomez',1,'3101112222','fernando.g@soluandinas.com',1),
(2,'102000112','Maria','Perez',1,'3102223333','maria.p@logitek.com',1);

INSERT INTO representante_proveedor (id_representante_legal, id_proveedor, cargo, creado_por) VALUES
(1,1,'Gerente General',1),
(2,2,'Representante Legal',1);

INSERT INTO socios_proveedor (id_proveedor, nombres, apellidos, id_tipo_identificacion, numero_identificacion, id_origen, fecha_extraccion, creado_por, validado) VALUES
(1,'Pedro','Alvarez',2,'102111222',1,NOW(),1,TRUE),
(2,'Lucia','Vega',2,'102111223',1,NOW(),1,FALSE),
(3,'Gonzalo','Mora',2,'102111224',1,NOW(),1,TRUE);
...
INSERT INTO documentos_socios_proveedor (id_socio_proveedor, id_documento, creado_por) VALUES 
(1,1,1),
(2,3,1);